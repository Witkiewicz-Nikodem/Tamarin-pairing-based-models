...
We also provide proof for abstract model that adversary can't distinguish two PEKS function evaluations despite he knows what messages were used to evaluate them. The proof is in PEKS-abs-obs-eq.spthy file. We tried to do the same with algebraic model but it proof is computationally too complex.
